$(document).ready(function(){
    ...
    $(document).on('click', '.mostrar-detalhes', function(){
        ...
        detalhes.slideDown();
        $(this).attr({
            'src': './imagens/menos_detalhes_icon.png',
    ...
    $(document).on('click', '.ocultar-detalhes', function(){
        ...
        detalhes.slideUp();
        $(this).attr({
            'src': './imagens/mais_detalhes_icon.png',
        ...
        if (nomeTarefa.css('text-decoration') === 'line-through'){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $(this).attr({
                        'src' : './imagens/realizadas_icon.png',
                        'class': 'concluido',
            ...
            const novaTarefa = $(`
                <ul id="tarefa">
                    <li id="tarefa-titulo">
                        ...
                        <img src="./imagens/realizadas_icon.png" class="concluir" title="Concluir tarefa" alt="Concluir tarefa">
                        <img src="./imagens/canceladas_icon.png" class="excluir" title="Excluir tarefa" alt="Excluir tarefa">
                        <img src="./imagens/mais_detalhes_icon.png" class="mostrar-detalhes" title="Mostrar detalhes" alt="Mostrar detalhes" />
                    </li>
